...
const nextConfig: NextConfig = {
  ...
  headers: async () => {
    ...
    const csp = [
      "default-src 'self'",
      "frame-src https: http: data: https://platform.twitter.com https://www.youtube.com https://www.youtube-nocookie.com https://www.instagram.com https://www.tiktok.com https://www.threads.net https://embed.nicovideo.jp https://note.com",
